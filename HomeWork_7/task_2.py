...
class PersonInfo:
    ...
    def short_name(self):
        """ Возвращаем фамилию и заглавную букву имени
        return: Фамилия И.
        """
    ...
    def path_deps(self):
        """ Выводим путь в структуре организации """
        path = ' --> '.join(self.departments)
        return path

    def new_salary(self):
        """ Вычисления индексации зарплаты
        return: Новая зарпалата
        """
        letter_counts = {}
        ...
        top_letters_counts = sorted_counts[:3]
        total_count = sum(top_letters_counts)
        salary = 1337 * self.age * total_count
        return salary

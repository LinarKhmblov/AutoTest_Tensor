# Статистика букв
# Написать функцию letter_stat, которая на вход принимает строку our_str и возвращает словарь letters_dict,
...
def letter_stat(our_str):
    """
    В данной функции с помощью цикла записываем количество повторений букв в строке.
    Если буква ранее не встречалась, её добавляют в словарь, если буква уже имеется в словаре, то идёт увеличение количества.
    @param our_str:
    @return:
    """

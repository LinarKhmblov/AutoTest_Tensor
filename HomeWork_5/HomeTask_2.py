...
def repeats(our_str):
    """ В данной функции мы создаем словарь "count", куда записываем встречающиеся на вход символы.
    Если символ встретился впервые, то записываем единицу, если уже встречался ранее добавляем ещё одну.
    Так же создали новую переменную "new_str", в которую с каждым проходом цикла добавляем символ с постфиксом и количество раз из словаря "count", сколько этот символ встречался ранее.
